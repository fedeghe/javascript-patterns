...
const gameSet = [
    ...
    new Uint8Array([0, 0, 3, 6, 0, 0, 0, 0, 0]),
    new Uint8Array([0, 7, 0, 0, 9, 0, 2, 0, 0]),
    new Uint8Array([0, 5, 0, 0, 0, 7, 0, 0, 0]),
    new Uint8Array([0, 0, 0, 0, 4, 5, 7, 0, 0]),
    new Uint8Array([0, 0, 0, 1, 0, 0, 0, 3, 0]),
    new Uint8Array([0, 0, 1, 0, 0, 0, 0, 6, 8]),
    new Uint8Array([0, 0, 8, 5, 0, 0, 0, 1, 0]),
    new Uint8Array([0, 9, 0, 0, 0, 0, 4, 0, 0])
  ]
...
console.time('so3')
console.log(new Sudoku().play(gameSet));
console.timeEnd('so3')