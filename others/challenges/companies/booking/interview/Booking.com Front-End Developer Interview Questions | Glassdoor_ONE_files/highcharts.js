		...
		line: { // base series options
			...
			dataLabels: merge(defaultLabelOptions, {
				...
				formatter: function () {
					 ...
					 * Add commas.
					 */
					var labelVal = String(this.y);
					for (var i = 0; i < Math.floor((labelVal.length - (1+i)) / 3); i=i+1) {
						labelVal = labelVal.substring( 0, labelVal.length - (4*i+3) ) + ',' +
							labelVal.substring( labelVal.length - (4*i+3) );
					}
					return labelVal;
				},
...
defaultPlotOptions.area = merge(defaultSeriesOptions, {
	threshold: 0,
	// GD CUSTOM: include dataLabels on area and area spline charts
	dataLabels: {
		distance: 10,
		enabled: true,
		y:-8,
		...
		formatter: function () {
			 ...
			 * Add commas.
			 */
			var labelVal = String(this.point.y);
			for (var i = 0; i < Math.floor((labelVal.length - (1+i)) / 3); i=i+1) {
				labelVal = labelVal.substring( 0, labelVal.length - (4*i+3) ) + ',' +
					labelVal.substring( labelVal.length - (4*i+3) );
			}
 ...
 */
// GD CUSTOM: include data labels on area spline charts
defaultPlotOptions.spline = merge(defaultSeriesOptions, {
		dataLabels: {
			...
			formatter: function () {
				 ...
				 * Add commas.
				 */
				var labelVal = String(this.point.value);
				for (var i = 0; i < Math.floor((labelVal.length - (1+i)) / 3); i=i+1) {
					labelVal = labelVal.substring( 0, labelVal.length - (4*i+3) ) + ',' +
						labelVal.substring( labelVal.length - (4*i+3) );
				}
